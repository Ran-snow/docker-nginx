...
* [`latest`,`amd64-1.17.2` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)
* [`arm64v8-1.17.2` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)
...
```
docker build -t rsnow/nginx:arm64v8-1.17.2 .
```

## 推送镜像

```
docker push rsnow/nginx:arm64v8-1.17.2
```
