...
* [`latest`,`amd64-1.23.1` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)
* ~~[`arm64v8-1.23.1` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)~~
...
2. 使用openssl 3.0.5, 并对openssl进行防篡改(gpg)校验。
...
~~docker build -t rsnow/nginx:arm64v8-1.23.1 .~~

## 推送镜像

~~docker push rsnow/nginx:arm64v8-1.23.1~~
