...
* [`latest`,`amd64-1.21.1` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)
* ~~[`arm64v8-1.21.1` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)~~
...
~~docker build -t rsnow/nginx:arm64v8-1.21.1 .~~

## 推送镜像

~~docker push rsnow/nginx:arm64v8-1.21.1~~
