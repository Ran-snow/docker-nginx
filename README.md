...
## 更新至 Nginx(mainline version) 1.23.0
## 更新至 Nginx(stable version) 1.22.0

## Tags 

* [`latest`,`amd64-1.23.0` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)
* ~~[`arm64v8-1.23.0` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)~~
...
~~docker build -t rsnow/nginx:arm64v8-1.23.0 .~~

## 推送镜像

~~docker push rsnow/nginx:arm64v8-1.23.0~~
