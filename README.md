...
* [`latest`,`amd64-1.15.11` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)
* [`arm64v8-1.15.11` (Dockerfile)](https://github.com/Ran-snow/docker-nginx/blob/master/Dockerfile)
